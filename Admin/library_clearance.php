                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <td><div align="center"><span class="controls"><img src="../<?php echo $row['photo'];?>" width="91" height="73" border="2"/></span></div></td>
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div align="center"><a href="clear_library.php" onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i class="fa fa-check" title="Click to Clear Student"> <span class="badge badge-warning">Pending</span></i> </a></div>
                          <?php } ?>
                        </td>
