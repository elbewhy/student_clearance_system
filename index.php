...
$department = $rowaccess["is_department_approved"];
$faculty = $rowaccess["is_faculty_approved"];
$clinic = $rowaccess["is_clinic_approved"];
$hostel = $rowaccess["is_hostel_approved"];
$sport = $rowaccess['is_sport_approved'];
$dbursar_saffairs = $rowaccess['is_dbursar_saffairs_approved'];
$stud_affairs = $rowaccess['is_stud_affairs_approved'];
$library = $rowaccess["is_example_approved"];
    ...
    ?>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-primary pull-right">Total Fee </span></h5>
                            </div>
							
                            <div class="ibox-content">
                                <h3 class="no-margins"><strong><strike>N</strike></strong><?php echo number_format((float) $tot_fee ,2); ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             		
<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins"><strong><strike>N</strike></strong><?php echo number_format((float) $tot_pay ,2); ?></h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>    
					...
					<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                          ...
                          <div class="ibox-content">
							  ...
							  <?php if (($outstanding_fee)=="0" && ($department)=="0" && ($faculty)=="0" && ($clinic)=="1" && ($sport)=="1" && ($hostel)=="1" &&($dbursar_saffairs)=="1" && ($stud_affairs)=="1"  && ($library)=="1")  { ?>
...
<?php echo "Pending"; ?></div>
	  <?php } ?> </h3>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins"><strong><strike>N</strike></strong><?php echo number_format((float) $outstanding_fee ,2); ?>  </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
            ...
            <table width="1201" height="341" align="center">
              <tr>
                <td width="1237"><table border="0" align="center" class="table table-hover no-margins">
                  <thead>
                    <tr>
                      <th width="11%%"><div align="center" class="style1">Fee </div></th>
                      <th width="11%"><div align="center" class="style1">Library</div></th>
                      <th width="11%"><div align="center" class="style1">Department</div></th>
                      <th width="11%"><div align="center" class="style1">Faculty</div></th>
                      <th width="12%"><div align="center" class="style1">Clinic</div></th>
					  <th width="12%"><div align="center" class="style1">Hostel</div></th>
                      <th width="12%"><div align="center" class="style1">Sport</div></th>
                      <th width="12%"><div align="center" class="style1">Deputy Bursar Student Affairs</div></th>
					   <th width="12%"><div align="center" class="style1">Secretary Student Affairs</div></th>
                    </tr>
                  </thead>
                  <tbody>
                   <tr>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_example_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_department_approved'])==(("1")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_faculty_approved'])==(("1")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_clinic_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_dbursar_saffairs_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
