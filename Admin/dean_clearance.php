...
$faculty = $row['faculty'];
$is_general_office = $row['is_general_office'];

// Now, fetch the students based on the admin's access level
if ($is_general_office == 1) {
    // For general offices, fetch all students
    $sql_students = "SELECT * FROM students ORDER BY ID ASC";
} else {
    // For specific offices, fetch only the students in the same office/department
    $sql_students = "SELECT * FROM students WHERE faculty='$faculty' ORDER BY ID ASC";
}
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dbursar.php">Home</a></li>
                  ...
                  <thead>
                    ...
                    <th width="13%"><div align="center">Photo</div></th>
                      <th width="8%"><div align="center">Fullname</div></th>                     
                       ...
                       <th width="9%"><div align="center">Faculty</div></th>
                
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $sql = "SELECT * FROM students WHERE faculty= '$faculty' ORDER BY ID ASC";
                    $result = $conn->query($sql);
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr class="gradeX">
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div align="center"><a href="clear_faculty.php" onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i class="fa fa-check" title="Click to Clear Student"> <span class="badge badge-warning">Pending</span></i> </a></div>
                          <?php } ?>
                        </td>
