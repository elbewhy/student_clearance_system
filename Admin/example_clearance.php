            ...
            <div class="card">
              ...
              <div class="card-body">
                <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                  <thead>
                    <tr>
                      <th width="25%"><div align="center">Photo</div></th>
                      <th width="25%"><div align="center">Fullname</div></th>
                      <th width="25%"><div align="center">Matric No</div></th>
                      <th width="25%"><div align="center">library Status</div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      <tr class="gradeX">
                       ...
                       <td height="104"><div align="center"><?php echo $row['fullname']; ?> </div></td>
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div align="center"><a href="clear_example.php?id=<?php echo $row['ID'];?>" onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i class="fa fa-check" title="Click to Clear Student"> <span class="badge badge-warning">Pending</span></i> </a></div>
                          <?php } ?>
                        </td>
