...
<section class="content">
  ...
  <thead>
    <tr>
    <th width="20%"><div align="center">Photo</div></th>
      <th width="20%"><div align="center">Fullname</div></th>
      <th width="20%"><div align="center">Matric No</div></th>
      <th width="20%"><div align="center">Faculty</div></th>
      <th width="20%"><div align="center">Department</div></th>
  ...
  <tbody>
    <?php
    $sql = "SELECT * FROM students WHERE  is_department_approved='0' AND is_faculty_approved='0' AND is_clinic_approved='1' AND is_hostel_approved='1' AND is_sport_approved='1' AND is_dbursar_saffairs_approved='1' AND is_stud_affairs_approved='1' AND is_example_approved='1'  ORDER BY ID ASC";
     $result = $conn->query($sql);
    ...
    <tr class="gradeX">
      ...
      <td height="104"><div align="center"><?php echo $row['faculty']; ?> </div></td>
      <td height="104"><div align="center"><?php echo $row['dept']; ?> </div></td>
      <td>
        <?php if ($row['is_department_approved'] == '0' && $row['is_faculty_approved'] == '0' && $row['is_clinic_approved'] == '1' && $row['is_hostel_approved'] == '1' && $row['is_sport_approved'] == '1' && $row['is_dbursar_saffairs_approved'] == '1' && $row['is_stud_affairs_approved'] == '1' && $row['is_example_approved'] == '1') { ?>
