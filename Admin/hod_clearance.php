...
if ($is_general_office == 1) {
    ...
    $sql_students = "SELECT * FROM students WHERE dept='$dept' ORDER BY ID ASC";
}
                  ...
                  <thead>
                    ...
                    <th width="13%"><div align="center">Photo</div></th>
                      <th width="8%"><div align="center">Fullname</div></th>                     
                       ...
                       <th width="9%"><div align="center">Department</div></th>
                
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $sql = "SELECT * FROM students WHERE dept= '$dept' ORDER BY ID ASC";
                    $result = $conn->query($sql);
