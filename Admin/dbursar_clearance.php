                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr class="gradeX">
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div align="center"><a href="clear_dbursar_saffairs.php?id=<?php echo $row['ID'];?>" onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i class="fa fa-check" title="Click to Clear Student"> <span class="badge badge-warning">Pending</span></i> </a></div>
                          <?php } ?>
                        </td>
