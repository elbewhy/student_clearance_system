...
// Retrieve the admin's department from the $row2 variable
$admin_department = $row2['dept'];

// Modify the SQL query to fetch students from the students table based on admin's department
$query = "SELECT * FROM students WHERE dept='$admin_department'";
$result_students = mysqli_query($conn, $query);

if ($result_students) {
    // it returns the number of rows in the table.
    $row_students = mysqli_num_rows($result_students);
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Head OF Department Admin Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
		   ...
		   <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><strong><strike>N</strike></strong><?php echo number_format((float) $tot_pay ,2); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
