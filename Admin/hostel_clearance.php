                ...
                <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                  <thead>
                    <tr>
                      ...
                      <th width="25%"><div align="center">Hostel Status</div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      <tr class="gradeX">
                       ...
                       <td height="104"><div align="center"><?php echo $row['fullname']; ?> </div></td>
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div align="center"><a href="clear_hostel.php?id=<?php echo $row['ID'];?>" onClick="return clear_student('<?php echo $row['matric_no']; ?>');"><i class="fa fa-check" title="Click to Clear Student"> <span class="badge badge-warning">Pending</span></i> </a></div>
                          <?php } ?>
                        </td>
