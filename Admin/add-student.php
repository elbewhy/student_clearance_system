...
if(isset($_POST["btnregister"]))
{
  ...
  $password_stud = mysqli_real_escape_string($conn, $_POST['txtmatric_no']);
...
$username='abubakarruwa5@gmail.com';//Note: urlencodemust be added forusernameand 
$password='admin123';// passwordas encryption code for security purpose.

$sender='KSUSTA-CLEARANCE-FORM';
...
?>
   ...
   <option value="cohs">College Of Health Science</option>
   <option value="eng">Engineering</option>
   <option value="evs">Environmental Science</option>
   <option value="lsc">Life Science</option>
   <option value="edusc">Science Education</option>
   <option value="psc">Physical Science</option>
    ...
    <option value="fish">Fishery</option>
    ...
    <option value="qts">Quantity Surveying</option>
