...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <option value="Deen Faculty">Deen Faculty</option>
   <option value="Head Of Clinic">Head Of Clinic</option>
   <option value="Hall Administrator">Hall Administrator</option>
   <option value="Sport Director">Sport Director</option>
   <option value="Deputy Bursar">Deputy Bursar</option>
   <option value="Secretary Student Affairs">Secretary Student Affairs</option>
   </select> 
  </div>
